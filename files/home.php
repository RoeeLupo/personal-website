	...
	<body>
		<div class="container">
			...
			<?php if(empty($config['allowed_ips']) || in_array($_SERVER['REMOTE_ADDR'], $config['allowed_ips'])){
					$ignore = Array("index.php", "home.php", "js", "css", ".", "..", "gallery.php", "img", "upload.php", "config.php", ".htaccess");
					$files1 = scandir(".");
				...
				<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			        ...
			        <tbody>
					 ...
					 <?php if($config['enable_delete']){?>   
					<td><a href="home.php?action=delete&filename=<?php echo $file;?>" class="btn btn-danger"  onclick="return confirm('Are you sure you want to permanently delete this file (<?php echo($file);?>) ?');">Delete file</a></td>
			            	<?php }?> 
					</tr>
			            <?php } }?>
			        </tbody>
